...
export default function changeTeamPick(teamPick=[], myTeamPick=[], tradeValue=[]) {
  ...
  const newTeamPickIndex = []
  if (changeAccept(teamPickSort, myTeamPickSort, dataTradeValue)) {
  ...
  } else return { acceptStatus: false };
}
